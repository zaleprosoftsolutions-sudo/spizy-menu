-- Spizy Menu — Ziina UAE checkout foundation
-- Run this after the previous payment status SQL files.
-- This keeps Spizy's own subscription gateway separate: Mamo Pay is for Spizy subscriptions;
-- Ziina here is for restaurants collecting payments from their customers.
