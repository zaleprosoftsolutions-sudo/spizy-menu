...
import { getSpizyLaunchModeLabel } from './launchMode'
  ...
  return (
    <section className="owner-dashboard-shell">
      ...
      {launchModeLabel === 'Launch-safe mode active' && (
        <div className="owner-dashboard-warning spizy-launch-mode-panel">
          <CheckCircle2 size={18} />
          <div>
            <strong>Launch-safe mode active</strong>
            <span>Core launch modules stay visible while beta/foundation tools are hidden until after announcement. Add VITE_SPIZY_SHOW_BETA_MODULES=true later to reveal all modules.</span>
          </div>
        </div>
      )}
            ...
            <section className="owner-dashboard-panel">
              ...
              <div className="owner-dashboard-action-grid">
                ...
                <QuickActionButton
                  ...
                  title="Mobile / PWA"
                  text="Install, offline and print checks"
                  onClick={() => onOpenSection('pwa-mobile')}
                />
                <QuickActionButton
                  icon={<WifiOff size={18} />}
                  title="Offline POS Queue"
                  text="Draft and sync orders"
                  onClick={() => onOpenSection('offline-pos')}
                />
                <QuickActionButton
                  icon={<ClipboardCheck size={18} />}
                  title="Launch QA"
                  text="Production simulation checklist"
                  onClick={() => onOpenSection('launch-qa')}
                />
                <QuickActionButton
                  icon={<FileText size={18} />}
                  title="Deploy Center"
                  text="SQL, functions and secrets"
                  onClick={() => onOpenSection('deployment-center')}
                />
                <QuickActionButton
                  icon={<Printer size={18} />}
                  title="Receipt / KOT Print"
                  text="Thermal receipt tests"
                  onClick={() => onOpenSection('receipt-print')}
                />
                <QuickActionButton
                  icon={<FileText size={18} />}
                  title="Tax Invoice Center"
                  text="VAT invoice preview"
                  onClick={() => onOpenSection('tax-invoice-center')}
                />
                <QuickActionButton
                ...
                <QuickActionButton
                  ...
                  text="Email, WhatsApp and push setup"
                  onClick={() => onOpenSection('notification-providers')}
                />
                <QuickActionButton
                  icon={<ClipboardCheck size={18} />}
                  title="Day Closing"
                ...
                <QuickActionButton
                  ...
                  text="Review role access"
                  onClick={() => onOpenSection('permissions-review')}
                />
                <QuickActionButton
                  icon={<ExternalLink size={18} />}
                  title="Public Menu"
